...
def test_the_negative_result_is_locked_not_smoothed():
    ...
    analysis = json.loads(breakeven_path.read_text(encoding="utf-8"))
    guarded = {"B2", "B3"}
...
def test_readme_concedes_razorpay_already_ships_recovery():
    ...
    text = _normalise((ROOT / "README.md").read_text(encoding="utf-8"))
...
def test_competitive_position_states_what_would_weaken_it():
    ...
    text = _normalise((ROOT / "docs" / "competitive_position.md").read_text(encoding="utf-8"))
...
def test_problem_evidence_states_its_sampling_caveat_before_its_numbers():
    ...
    lowered = _normalise((ROOT / "docs" / "problem_evidence.md").read_text(encoding="utf-8"))
...
def test_problem_evidence_disclaims_feeding_the_benchmark():
    ...
    text = _normalise((ROOT / "docs" / "problem_evidence.md").read_text(encoding="utf-8"))
