...
| | |
|---|---|
| Final ZIP | `mandateguard_submission_final_rillet_inspired.zip` |
| Size | 1,231,226 bytes |
| SHA256 | `b26eaacb519a11b6ed42e2f507770f6c640b3574bc92baf580e2c84d377a3638` |
| Archive root | `mandateguard_policy_lab/` |
| Files under checksum | 86 |
| `unzip -t` | no errors detected |
| Final gate | extracted into a new directory, fresh venv, no `PYTHONPATH`: 280 passed, 14/14 mutations, release gate passed, four stages passed, 86/86 verify |
