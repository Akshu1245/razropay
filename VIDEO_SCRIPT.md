...
If Test Mode has not been run yet, **do not fake this section**. State that the adapter and offline contract harness are implemented and that credentialed Test Mode evidence is still pending.
