...
What is executable and falsifiable: webhook HMAC validation, attacked 42 ways in tests; replay/order controls; deterministic authority attenuation; guardrails; provider-call accounting; abstention; timeout handling; audit verification; and the independent checker. The historical baseline contained 299 tests and a 14/14 mutation check. See FINAL_VERIFICATION.md for the revised tree’s observed counts.
